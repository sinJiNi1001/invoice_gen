...
ALTER TABLE customers CHANGE address1 address VARCHAR(255);
ALTER TABLE customers ADD COLUMN address2 VARCHAR(255) AFTER address1;
ALTER TABLE customers ADD COLUMN pincode VARCHAR(20) AFTER state;
SELECT* FROM customers;

ALTER TABLE customers DROP COLUMN gst_file_path;
